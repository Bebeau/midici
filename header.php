...
<head>
	...
	<?php if (is_single()) { ?>
		...
		<meta property="twitter:site" content="@mymidici"> 
		...
		<meta property="twitter:creator" content="@mymidici"> 
...
<header>
    <nav class="hidden-xs clearfix">
        ...
        <?php 
            $menuArgs = array( 
                ...
                'container_class' => 'col-sm-8 col-sm-offset-2'
            );
    ...
    <nav class="visible-xs">
        ...
        <button class="btn-main" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
